				...
				<section>
					<div className='row showcase'>
						<div className='col-lg-8'>
							...
							<p>
								A privacidade dos usuários é uma prioridade para mim. Esta política de privacidade explica como eu lido com as informações pessoais que podem ser coletadas durante o uso o meu bot utilizado na plataforma do Discord, esta política não é sobre o servidor em si. É
								importante ressaltar que minha aplicação não armazena nenhuma informação e não solicita acesso a nenhum usuário. Ela é exclusivamente utilizada pelo administrador do servidor para gerenciar eventos e conectar com outros serviços usando as informações públicas
								disponíveis no servidor do Discord.
							</p>
							...
							<p>
								...
								servidor do Discord. Não realizo qualquer processamento adicional dessas informações.
							</p>
							...
							<p>Posso atualizar esta política de privacidade de tempos em tempos, caso seja necessário. Quaisquer alterações significativas serão comunicadas aos usuários por meio de um aviso destacado na minha aplicação Discord.</p>
